...
<body style="background: #ffffff;">
	<div class="modal-body">
     	<form id="data_form" method="post" enctype="multipart/form-data" class="form-horizontal " url="${webRoot}/sysLeftMenu/doAdd.do">
            ...
            <div class="form-group">
                ...
                <div class="col-md-9">
                    <input type="text" id="idx" name="idx" class="form-control" placeholder="数字，越小越靠前">
                    <span class="help-block" atr="info"></span>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
	            ...
	            <div class="col-md-9">
					...
					<button type="button" class="btn btn-info option" value="1">有子菜单</button>
					<button type="button" class="btn btn-default option" value="2">菜单链接</button>
				</div>
            </div>
            <div class="form-group">
		          		...
		          		<c:forEach items="${sysResources }" var="sr" varStatus="i">
		          			<c:if test="${fn:length(sr.sons)>0 }">
		          				...
		          				<c:forEach items="${sr.sons }" var="son">
		          					<option value="${son.id }">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${son.name }(${son.url })</option>
		          				</c:forEach>
		          			</c:if>
		          		</c:forEach>
					</select>
