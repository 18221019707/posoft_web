...
<body style="background: #ffffff;">
	<div class="modal-body">
     	<form id="data_form" method="post" enctype="multipart/form-data" class="form-horizontal " url="${webRoot}/sysRole/doEdit.do">
            ...
            <div class="form-group">
                ...
                <div class="col-md-9">
                    <input type="text" id="name" name="name" class="form-control" placeholder="角色名称" value="${sysRole.name}">
            ...
            <div class="form-group">
                ...
                <div class="col-md-9">
                    <input type="text" id="code" name="code" class="form-control" placeholder="角色代码" value="${sysRole.code}">
                    <span class="help-block" atr="info"></span>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-md-9">
                    <textarea id="memo" name="memo" rows="9" class="form-control" placeholder="内容..." value="${sysRole.memo}"></textarea>
                    <span class="help-block" atr="info"></span>
                </div>
            </div>						
			<br>
