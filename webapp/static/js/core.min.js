...
$(document).ready(function(e) {
    ...
    e("ul.nav-sidebar").find("a").each(function() {
        if ($($(this)[0]).attr("url") == String(e("#curUrl").val())||$($(this)[0]).attr("url") == (String(e("#curUrl").val())+"")) {
            e(this).parent().addClass("active");
            e(this).parents("ul").add(this).each(function() {
                e(this).show().parent().addClass("opened");
            });
            $('.page-header').html('<i class="fa fa-table"></i>'+ e(this).find(".text").text());
            $('#panel-heading h2').html('<i class="fa fa-table red"></i><span class="break"></span><strong>'+ e(this).find(".text").text()+'</strong>');
        }else{
