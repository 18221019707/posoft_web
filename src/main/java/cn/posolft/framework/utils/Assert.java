...
public abstract class Assert {
	...
	public static void doesNotContain(String textToSearch, String substring, String message) {
		if (StringUtil.notBlank(textToSearch) && StringUtil.notBlank(substring) && textToSearch.contains(substring)) {
			throw new IllegalArgumentException(message);
		}
	}
	...
	public static void isInstanceOf(Class<?> type, Object obj, String message) {
		...
		if (!type.isInstance(obj)) {
			throw new IllegalArgumentException((StringUtil.notBlank(message) ? message + " " : "") + "Object of class [" + (obj != null ? obj.getClass().getName() : "null")
