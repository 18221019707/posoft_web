...
import cn.posolft.framework.web.view.View.ContentType;
...
public class ViewFactory {
	...
	public static AuthCodeView authCode(int len, String sessionKey) {
		return new AuthCodeView().setSize(len).setSessionKey(sessionKey);
	}
	...
	public static AuthCodeView authCode(String authCode, String sessionKey) {
		return new AuthCodeView().setAuthCode(authCode).setSessionKey(sessionKey);
	}
